...
<xsl:stylesheet xmlns:f="http://docbook.org/xslt/ns/extension" xmlns="http://www.w3.org/1999/xhtml" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:db="http://docbook.org/ns/docbook" xmlns:m="http://docbook.org/xslt/ns/mode" xmlns:h="http://www.w3.org/1999/xhtml" xmlns:t="http://docbook.org/xslt/ns/template" xmlns:doc="http://nwalsh.com/xsl/documentation/1.0" xmlns:fn="http://www.w3.org/2005/xpath-functions" exclude-result-prefixes="db doc f fn h m t" version="2.0">
    ...
    <xsl:template match="db:classsynopsis                      |db:fieldsynopsis                      |db:methodsynopsis                      |db:constructorsynopsis                      |db:destructorsynopsis">
    ...
    <xsl:template name="t:synop-break">
        <xsl:if test="parent::db:classsynopsis                 or (following-sibling::db:fieldsynopsis                     |following-sibling::db:methodsynopsis                     |following-sibling::db:constructorsynopsis                     |following-sibling::db:destructorsynopsis)">
            <br/>
        </xsl:if>
    </xsl:template>
...
<!-- ===== Java ======================================================== -->
    <xsl:template match="db:classsynopsis" mode="java">
        <pre>
            ...
            <xsl:text>&#160;{</xsl:text>
            <br/>
            <xsl:apply-templates select="db:constructorsynopsis                                  |db:destructorsynopsis                                  |db:fieldsynopsis                                  |db:methodsynopsis                                  |db:classsynopsisinfo" mode="java"/>
            <xsl:text>}</xsl:text>
        </pre>
    </xsl:template>
    ...
    <xsl:template mode="java" match="db:constructorsynopsis|db:destructorsynopsis|db:methodsynopsis">
...
<!-- ===== C++ ========================================================= -->
    <xsl:template match="db:classsynopsis" mode="cpp">
        <pre>
            ...
            <xsl:text>&#160;{</xsl:text>
            <br/>
            <xsl:apply-templates select="db:constructorsynopsis                                  |db:destructorsynopsis                                  |db:fieldsynopsis                                  |db:methodsynopsis                                  |db:classsynopsisinfo" mode="cpp"/>
            <xsl:text>}</xsl:text>
        </pre>
    </xsl:template>
    ...
    <xsl:template mode="cpp" match="db:constructorsynopsis|db:destructorsynopsis|db:methodsynopsis">
        <xsl:variable name="modifiers" select="db:modifier"/>
        <xsl:variable name="notmod" select="*[not(self::db:modifier)]"/>
        <code>
            <xsl:sequence select="f:html-attributes(.)"/>
...
<!-- ===== IDL ========================================================= -->
    <xsl:template match="db:classsynopsis" mode="idl">
        <pre>
            ...
            <xsl:text>&#160;{</xsl:text>
            <br/>
            <xsl:apply-templates select="db:constructorsynopsis                                  |db:destructorsynopsis                                  |db:fieldsynopsis                                  |db:methodsynopsis                                  |db:classsynopsisinfo" mode="idl"/>
            <xsl:text>}</xsl:text>
        </pre>
    </xsl:template>
    ...
    <xsl:template mode="idl" match="db:constructorsynopsis|db:destructorsynopsis|db:methodsynopsis">
        <xsl:variable name="modifiers" select="db:modifier"/>
        <xsl:variable name="notmod" select="*[not(self::db:modifier)]"/>
        <code>
            <xsl:sequence select="f:html-attributes(.)"/>
...
<!-- ===== Perl ======================================================== -->
    <xsl:template match="db:classsynopsis" mode="perl">
        <pre>
            ...
            <xsl:apply-templates select="db:constructorsynopsis                                  |db:destructorsynopsis                                  |db:fieldsynopsis                                  |db:methodsynopsis                                  |db:classsynopsisinfo" mode="perl"/>
        </pre>
    </xsl:template>
    ...
    <xsl:template mode="perl" match="db:constructorsynopsis|db:destructorsynopsis|db:methodsynopsis">
        <xsl:variable name="modifiers" select="db:modifier"/>
        <xsl:variable name="notmod" select="*[not(self::db:modifier)]"/>
        <code>
            <xsl:sequence select="f:html-attributes(.)"/>

...
<xsl:stylesheet xmlns:f="http://docbook.org/xslt/ns/extension" xmlns="http://www.w3.org/1999/xhtml" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:db="http://docbook.org/ns/docbook" xmlns:m="http://docbook.org/xslt/ns/mode" xmlns:u="http://nwalsh.com/xsl/unittests#" xmlns:t="http://docbook.org/xslt/ns/template" xmlns:doc="http://nwalsh.com/xsl/documentation/1.0" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:fn="http://www.w3.org/2005/xpath-functions" exclude-result-prefixes="db doc f fn m t u xlink" version="2.0">
...
calling “apply templates” with the current context node.</para>
        ...
        <u:unittests template="t:inline-charseq">
            <u:test>
                ...
                <u:result>
                    <span xmlns="http://www.w3.org/1999/xhtml" class="varname" id="varfoo">someVarName</span>
                </u:result>
            </u:test>
        </u:unittests>
    </doc:template>
...
the default is “element”.</para>
    ...
    <u:unittests match="db:emphasis">
        ...
        <u:test>
            ...
            <u:result>
                <strong class="emphasis">Something strongly emphasized</strong>
            </u:result>
        </u:test>
    </u:unittests>
    <xsl:template match="db:emphasis">
        ...
        <xsl:choose>
            <xsl:when test="$classes = 'bold' or $classes = 'strong'">
                <strong>
                    <xsl:sequence select="f:html-attributes(., @xml:id, local-name(.),                                                 $classes[(. != 'bold') and (. != 'strong')])"/>
                    <xsl:call-template name="t:xlink"/>
                </strong>
            </xsl:when>
            <xsl:otherwise>
...
and <tag>firstterm</tag> elements.</para>
    ...
    <xsl:template match="db:glossterm" name="db:glossterm">
        ...
        <xsl:variable name="extra-class" select="if (self::db:firstterm or $firstterm = 0) then () else 'firstterm'"/>
        <em>

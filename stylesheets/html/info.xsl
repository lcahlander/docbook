...
<xsl:stylesheet xmlns:f="http://docbook.org/xslt/ns/extension" xmlns="http://www.w3.org/1999/xhtml" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:db="http://docbook.org/ns/docbook" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:m="http://docbook.org/xslt/ns/mode" xmlns:h="http://www.w3.org/1999/xhtml" xmlns:t="http://docbook.org/xslt/ns/template" xmlns:fn="http://www.w3.org/2005/xpath-functions" exclude-result-prefixes="db f fn h m t xs" version="2.0">

<!-- many info elements are handled by ../common/inlines.xsl -->
    <xsl:template match="db:orgname|db:orgdiv|db:shortaffil|db:artpagenums                      |db:confdates|db:conftitle|db:confnum                      |db:confsponsor|db:contractnum|db:contractsponsor                      |db:volumenum|db:issuenum|db:seriesvolnums">
        <span>
    ...
    <xsl:template match="db:revhistory">
        ...
        <xsl:variable name="has-author" select="db:revision/db:author        |db:revision/db:authorinitials"/>

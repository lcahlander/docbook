...
<!-- ============================================================ -->
    <xsl:template match="db:msgset">
        <xsl:call-template name="t:semiformal-object">
            <xsl:with-param name="placement" select="$formal.title.placement[self::db:msgset]/@placement"/>
    ...
    <xsl:template match="db:msgset/db:info/db:title" mode="m:titlepage-mode" priority="100">
        <div class="title">
            <xsl:next-match/>
        </div>
    </xsl:template>
    <xsl:template match="db:msgentry">
        <xsl:call-template name="t:semiformal-object">
            <xsl:with-param name="placement" select="$formal.title.placement[self::db:msgentry]/@placement"/>
            <xsl:with-param name="class" select="local-name(.)"/>
            <xsl:with-param name="object" as="element()">
                <div>
                    <xsl:sequence select="f:html-class(., local-name(.), @role)"/>
    ...
    <xsl:template match="db:msgentry/db:info/db:title" mode="m:titlepage-mode" priority="100">
        <div class="title">
            <xsl:next-match/>
        </div>
    </xsl:template>
    ...
    <xsl:template match="db:msg">
        <xsl:call-template name="t:semiformal-object">
            <xsl:with-param name="placement" select="$formal.title.placement[self::db:msg]/@placement"/>
            <xsl:with-param name="class" select="local-name(.)"/>
            <xsl:with-param name="object" as="element()">
                <div>
                    <xsl:sequence select="f:html-class(., local-name(.), @role)"/>
    ...
    <xsl:template match="db:msg/db:info/db:title" mode="m:titlepage-mode" priority="100">
        <div class="title">
            <xsl:next-match/>
        </div>
    </xsl:template>
    ...
    <xsl:template match="db:msgexplan">
        <xsl:call-template name="t:semiformal-object">
            <xsl:with-param name="placement" select="$formal.title.placement[self::db:msgexplan]/@placement"/>
            <xsl:with-param name="class" select="local-name(.)"/>
            <xsl:with-param name="object" as="element()">
                <div>
                    <xsl:sequence select="f:html-class(., local-name(.), @role)"/>
    ...
    <xsl:template match="db:msgexplan/db:info/db:title" mode="m:titlepage-mode" priority="100">
        <div class="title">
            <xsl:next-match/>
        </div>
    </xsl:template>

...
<xsl:stylesheet xmlns:f="http://docbook.org/xslt/ns/extension" xmlns="http://www.w3.org/1999/xhtml" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:db="http://docbook.org/ns/docbook" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:m="http://docbook.org/xslt/ns/mode" xmlns:h="http://www.w3.org/1999/xhtml" xmlns:u="http://nwalsh.com/xsl/unittests#" xmlns:t="http://docbook.org/xslt/ns/template" xmlns:doc="http://nwalsh.com/xsl/documentation/1.0" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:fn="http://www.w3.org/2005/xpath-functions" exclude-result-prefixes="db doc f fn h m t u xlink xs" version="2.0">
...
<!-- ============================================================ -->
    <doc:template xmlns="http://docbook.org/ns/docbook" match="db:link">
...
attribute or a <tag class="attribute">linkend</tag> attribute:</para>
            <informaltable rowheader="firstcol">
                <tgroup cols="3">
                    ...
                    <tbody>
                        <row>
                            <entry>Has <tag class="attribute">xlink:href</tag>
                            </entry>
...
specified URI.</entry>
                        ...
                        <row>
                            <entry>Has <tag class="attribute">linkend</tag>
                            </entry>
...
<!-- ============================================================ -->
    <doc:template xmlns="http://docbook.org/ns/docbook" name="db:xref" match="db:xref">
...
<!-- ============================================================ -->
    <doc:template xmlns="http://docbook.org/ns/docbook" name="t:xref-xreflabel">
...
<!-- ============================================================ -->
    <doc:mode xmlns="http://docbook.org/ns/docbook" name="m:insert-title-markup">
...
<!-- ==================================================================== -->
    <doc:mode xmlns="http://docbook.org/ns/docbook" name="m:insert-subtitle-markup">
...
<!-- ==================================================================== -->
    <doc:mode xmlns="http://docbook.org/ns/docbook" name="m:insert-label-markup">
...
<!-- ==================================================================== -->
    <doc:mode xmlns="http://docbook.org/ns/docbook" name="m:insert-pagenumber-markup">
...
<!-- ==================================================================== -->
    <doc:mode xmlns="http://docbook.org/ns/docbook" name="m:insert-direction-markup">
...
<!-- ==================================================================== -->
    <doc:mode xmlns="http://docbook.org/ns/docbook" name="m:insert-olink-docname-markup">
...
<!-- ==================================================================== -->
    <doc:mode xmlns="http://docbook.org/ns/docbook" name="m:endterm">
...
<!-- ==================================================================== -->
    <doc:mode xmlns="http://docbook.org/ns/docbook" name="m:remove-ids">
...
<!-- ==================================================================== -->
    <doc:mode xmlns="http://docbook.org/ns/docbook" name="m:xref-to-prefix">
...
to cross references to that element.</para>
    ...
    <xsl:template match="db:biblioentry|db:bibliomixed" mode="m:xref-to-prefix" priority="100">
        <xsl:text>[</xsl:text>
    </xsl:template>
    <xsl:template match="*" mode="m:xref-to-prefix"/>

<!-- ==================================================================== -->
    <doc:mode xmlns="http://docbook.org/ns/docbook" name="m:xref-to-suffix">
...
to cross references to that element.</para>
    ...
    <xsl:template match="db:biblioentry|db:bibliomixed" mode="m:xref-to-suffix" priority="100">
        <xsl:text>]</xsl:text>
    </xsl:template>
    <xsl:template match="*" mode="m:xref-to-suffix"/>

<!-- ==================================================================== -->
    <doc:mode xmlns="http://docbook.org/ns/docbook" name="m:xref-to">
...
cross references to that element.</para>
  ...
  <!-- if you xref to a title, xref to the parent... -->
    ...
    <xsl:template match="db:abstract|db:authorblurb|db:personblurb|db:bibliodiv        |db:bibliomset|db:biblioset|db:blockquote|db:calloutlist        |db:caution|db:colophon|db:constraintdef|db:formalpara        |db:glossdiv|db:important|db:indexdiv|db:itemizedlist        |db:legalnotice|db:lot|db:msg|db:msgexplan|db:msgmain        |db:msgrel|db:msgset|db:msgsub|db:note|db:orderedlist        |db:partintro|db:productionset|db:qandadiv        |db:refsynopsisdiv|db:segmentedlist|db:set|db:setindex        |db:sidebar|db:tip|db:toc|db:variablelist|db:warning" mode="m:xref-to">
        <xsl:param name="referrer"/>
        <xsl:param name="xrefstyle"/>
        <xsl:param name="verbose" select="1"/>
  ...
  <!-- catch-all for things with (possibly optional) titles -->
    ...
    <xsl:template match="db:author|db:editor|db:othercredit|db:personname" mode="m:xref-to">
        <xsl:param name="referrer"/>
        <xsl:param name="xrefstyle"/>
    ...
    <xsl:template match="db:dedication|db:preface        |db:chapter|db:appendix|db:article" mode="m:xref-to">
        <xsl:param name="referrer"/>
        <xsl:param name="xrefstyle"/>
        <xsl:apply-templates select="." mode="m:object-xref-markup">
            <xsl:with-param name="purpose" select="'xref'"/>
    ...
    <xsl:template match="db:biblioentry|db:bibliomixed" mode="m:xref-to">
        <xsl:param name="referrer"/>
        <xsl:param name="xrefstyle"/>
        <xsl:variable name="context" select="(ancestor::db:bibliography            |ancestor::db:bibliolist)[last()]"/>
  ...
  <!-- handles both biblioentry and bibliomixed -->
    ...
    <xsl:template match="db:section|db:simplesect                      |db:sect1|db:sect2|db:sect3|db:sect4|db:sect5                      |db:refsect1|db:refsect2|db:refsect3|db:refsection" mode="m:xref-to">
        <xsl:param name="referrer"/>
        <xsl:param name="xrefstyle"/>
        <xsl:apply-templates select="." mode="m:object-xref-markup">
            <xsl:with-param name="purpose" select="'xref'"/>
  ...
  <!-- to avoid the comma that will be generated if there are several terms -->
    ...
    <xsl:template match="db:areaset" mode="m:xref-to">
        <xsl:call-template name="t:callout-bug">
            <xsl:with-param name="conum" select="count(preceding-sibling::db:areaset        |preceding-sibling::db:area)        +1"/>
        </xsl:call-template>
    </xsl:template>
    <xsl:template match="db:area" mode="m:xref-to">
        <xsl:call-template name="t:callout-bug">
            <xsl:with-param name="conum" select="count(parent::db:areaset/preceding-sibling::db:areaset              |parent::db:areaset/preceding-sibling::db:area       |preceding-sibling::db:area)        +1"/>
        </xsl:call-template>
    </xsl:template>
    ...
    <xsl:template match="db:para" mode="m:xref-to">
        <xsl:param name="referrer"/>
        <xsl:param name="xrefstyle"/>
        <xsl:variable name="context" select="(ancestor::db:simplesect                                        |ancestor::db:section                                        |ancestor::db:sect1                                        |ancestor::db:sect2                                        |ancestor::db:sect3                                        |ancestor::db:sect4                                        |ancestor::db:sect5                                        |ancestor::db:refsection                                        |ancestor::db:refsect1                                        |ancestor::db:refsect2                                        |ancestor::db:refsect3                                        |ancestor::db:chapter                                        |ancestor::db:appendix                                        |ancestor::db:preface                                        |ancestor::db:partintro                                        |ancestor::db:dedication                                        |ancestor::db:colophon                                        |ancestor::db:bibliography                                        |ancestor::db:index                                        |ancestor::db:glossary                                        |ancestor::db:glossentry                                        |ancestor::db:listitem                                        |ancestor::db:varlistentry)[last()]"/>
        <xsl:apply-templates select="$context" mode="m:xref-to"/>
    </xsl:template>

<!-- ============================================================ -->
    <doc:mode xmlns="http://docbook.org/ns/docbook" name="m:xref">

...
<xsl:stylesheet xmlns:f="http://docbook.org/xslt/ns/extension" xmlns="http://www.w3.org/1999/xhtml" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:db="http://docbook.org/ns/docbook" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:m="http://docbook.org/xslt/ns/mode" xmlns:h="http://www.w3.org/1999/xhtml" xmlns:t="http://docbook.org/xslt/ns/template" exclude-result-prefixes="db f h m t xs" version="2.0">
...
<!-- ==================================================================== -->
    <xsl:template name="t:process-footnotes">
        <xsl:variable name="table.footnotes" select=".//db:tgroup//db:footnote|.//db:tr//db:footnote"/>
  ...
  <!-- nop -->
    ...
    <xsl:template match="db:footnote" name="t:process-footnote" mode="m:process-footnote-mode">
        <xsl:variable name="name" select="f:node-id(.)"/>
        <xsl:variable name="footnote.body.doc">
            <xsl:apply-templates/>
        </xsl:variable>
        <xsl:variable name="footnote.body" as="element()*" select="$footnote.body.doc/*"/>
    ...
    <xsl:template match="db:tgroup//db:footnote" mode="m:process-footnote-mode"/>

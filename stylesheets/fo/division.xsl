...
<!-- ==================================================================== -->
    <xsl:template match="db:book">
        ...
        <xsl:call-template name="t:page-sequence">
            <xsl:with-param name="master-reference" select="f:select-pagemaster(.,'titlepage')"/>

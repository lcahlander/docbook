...
<xsl:stylesheet xmlns:f="http://docbook.org/xslt/ns/extension" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:db="http://docbook.org/ns/docbook" xmlns:m="http://docbook.org/xslt/ns/mode" xmlns:u="http://nwalsh.com/xsl/unittests#" xmlns:t="http://docbook.org/xslt/ns/template" xmlns:doc="http://nwalsh.com/xsl/documentation/1.0" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:fn="http://www.w3.org/2005/xpath-functions" exclude-result-prefixes="db doc f fn m t u xlink" version="2.0">
...
<!-- ============================================================ -->
    <doc:template xmlns="http://docbook.org/ns/docbook" name="t:simple-xlink">
...
context item.</para>
    ...
    <xsl:template name="t:simple-xlink">
	    ...
	    <!-- or if the href starts with #xpointer(id(, it's just an ID -->
                            <xsl:when test="starts-with($node/@xlink:href,'#')                             and (not(contains($node/@xlink:href,'('))                             or starts-with($node/@xlink:href,                       '#xpointer(id('))">
	    ...
	    <!-- otherwise it's a URI -->
                    ...
                    <fo:basic-link xsl:use-attribute-sets="xref.properties" external-destination="url({$url})">
...
<!-- ============================================================ -->
    <doc:template xmlns="http://docbook.org/ns/docbook" name="t:inline-charseq">
...
calling “apply templates” with the current context node.</para>
        ...
        <u:unittests template="t:inline-charseq">
            <u:test>
                ...
                <u:result>
                    <fo:inline id="varfoo">someVarName</fo:inline>
                </u:result>
            </u:test>
        </u:unittests>
    </doc:template>
...
<!-- ============================================================ -->
    <doc:template xmlns="http://docbook.org/ns/docbook" name="t:inline-monoseq">
...
<!-- ============================================================ -->
    <doc:template xmlns="http://docbook.org/ns/docbook" name="t:inline-boldseq">
...
<!-- ============================================================ -->
    <doc:template xmlns="http://docbook.org/ns/docbook" name="t:inline-italicseq">
...
<!-- ============================================================ -->
    <doc:template xmlns="http://docbook.org/ns/docbook" name="t:inline-boldmonoseq">
...
that element will be used as the <tag class="attribute">title</tag> of the <tag>strong</tag>.</para>
...
<!-- ============================================================ -->
    <doc:template xmlns="http://docbook.org/ns/docbook" name="t:inline-italicmonoseq">
...
<tag class="attribute">id</tag>.</para>
            <para>If the element has an
<tag>alt</tag> element among its children, the string-value of
that element will be used as the <tag class="attribute">title</tag> of the <tag>em</tag>.</para>
...
<!-- ============================================================ -->
    <doc:template xmlns="http://docbook.org/ns/docbook" name="t:inline-superscriptseq">
...
<!-- ============================================================ -->
    <doc:template xmlns="http://docbook.org/ns/docbook" name="t:inline-subscriptseq">
...
<!-- ============================================================ -->
    <doc:template xmlns="http://docbook.org/ns/docbook" name="format-tag">
...
the default is “element”.</para>
    ...
    <u:unittests match="db:emphasis">
        <u:test>
            ...
            <u:result>
                <fo:em>Something emphasized</fo:em>
            </u:result>
        </u:test>
        <u:test>
            <u:context as="element()">
            ...
            <u:result>
                <fo:strong class="emphasis">Something strongly emphasized</fo:strong>
            </u:result>
        </u:test>
    </u:unittests>
...
<!-- ============================================================ -->
    <doc:template xmlns="http://docbook.org/ns/docbook" name="db:glossterm">
...
and <tag>firstterm</tag> elements.</para>
	...
	-->
                ...
                <xsl:when test="not(@linkend)         and ($firstterm.only.link = 0 or $firstterm = 1)         and $glossterm.auto.link != 0">
                    ...
                    <xsl:variable name="targets" select="//db:glossentry            [normalize-space(db:glossterm) = $term             or normalize-space(db:glossterm/@baseform)         = $term]"/>

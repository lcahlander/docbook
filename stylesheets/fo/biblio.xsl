...
<!-- ==================================================================== -->
  ...
  <!-- suppressed -->
    ...
    <xsl:template match="db:article/db:info" mode="m:biblioentry-mode">
        <fo:inline>
            <xsl:apply-templates mode="m:biblioentry-mode"/>
            <xsl:value-of select="$biblioentry.item.separator"/>
        </fo:inline>
...
<!-- ================================================== -->
    ...
    <xsl:template match="db:biblioset/db:title|db:biblioset/db:citetitle" mode="m:biblioentry-mode">
...
<!-- ================================================== -->
    ...
    <xsl:template match="db:bibliocoverage|db:biblioid|db:bibliorelation|db:bibliosource" mode="m:biblioentry-mode">
        <fo:inline>
            <xsl:apply-templates mode="m:biblioentry-mode"/>
            <xsl:value-of select="$biblioentry.item.separator"/>
        </fo:inline>
...
<!-- ================================================== -->
    ...
    <xsl:template match="db:bibliomset/db:title|db:bibliomset/db:citetitle" mode="m:bibliomixed-mode">
        <xsl:variable name="relation" select="../@relation"/>
        <xsl:choose>
            <xsl:when test="$relation='article' or @pubwork='article'">
                <xsl:call-template name="gentext-startquote"/>
...
<!-- ================================================== -->
    ...
    <xsl:template match="db:bibliocoverage|db:biblioid|db:bibliorelation|db:bibliosource" mode="m:bibliomixed-mode">
        <fo:inline>
            <xsl:apply-templates mode="m:bibliomixed-mode"/>
        </fo:inline>
    </xsl:template>

...
<xsl:stylesheet xmlns:f="http://docbook.org/xslt/ns/extension" xmlns:db="http://docbook.org/ns/docbook" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:m="http://docbook.org/xslt/ns/mode" xmlns:t="http://docbook.org/xslt/ns/template" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:fn="http://www.w3.org/2005/xpath-functions" exclude-result-prefixes="f m fn db t" version="2.0">
    ...
    <xsl:template match="db:important/db:title"/>
    <xsl:template match="db:warning/db:title"/>
    <xsl:template match="db:caution/db:title"/>
    <xsl:template match="db:tip/db:title"/>
</xsl:stylesheet>
...
<xsl:stylesheet xmlns:f="http://docbook.org/xslt/ns/extension" xmlns:db="http://docbook.org/ns/docbook" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:m="http://docbook.org/xslt/ns/mode" xmlns:t="http://docbook.org/xslt/ns/template" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:axf="http://www.antennahouse.com/names/XSL/Extensions" exclude-result-prefixes="db f m t" version="2.0">
...
<!-- ==================================================================== -->
    ...
    <xsl:template name="t:section-content">
        <xsl:variable name="toc.params" select="f:find-toc-params(., $generate.toc)"/>
        <fo:block>
    ...
    <xsl:template match="db:sect1/db:info"/>
    <xsl:template match="db:sect2/db:info"/>
    <xsl:template match="db:sect3/db:info"/>
    <xsl:template match="db:sect4/db:info"/>
    <xsl:template match="db:sect5/db:info"/>
    <xsl:template match="db:simplesect/db:info"/>

...
<xsl:stylesheet xmlns:f="http://docbook.org/xslt/ns/extension" xmlns:db="http://docbook.org/ns/docbook" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:mp="http://docbook.org/xslt/ns/mode/private" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:m="http://docbook.org/xslt/ns/mode" exclude-result-prefixes="db f mp xs" version="2.0">
...
<!--	   select="'../../docbook/relaxng/dita4db/dita4db.rng'"/> -->
    ...
    <xsl:template xmlns:r="http://nwalsh.com/xmlns/schema-remap/" xmlns:rng="http://relaxng.org/ns/structure/1.0" match="*" mode="m:schemaextensions">
  ...
  -->
    ...
    <xsl:template match="comment()|processing-instruction()|text()" mode="m:schemaextensions">
        <xsl:copy/>
    </xsl:template>

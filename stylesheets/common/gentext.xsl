...
<xsl:stylesheet xmlns:f="http://docbook.org/xslt/ns/extension" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:db="http://docbook.org/ns/docbook" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:l="http://docbook.sourceforge.net/xmlns/l10n/1.0" xmlns:m="http://docbook.org/xslt/ns/mode" xmlns:ghost="http://docbook.org/ns/docbook/ephemeral" xmlns:doc="http://nwalsh.com/xsl/documentation/1.0" exclude-result-prefixes="db doc f l m xs ghost" version="2.0">
...
<!-- ============================================================ -->
    <doc:mode xmlns="http://docbook.org/ns/docbook" name="m:object-title-template">
...
that should be used to generate its title.</para>
    ...
    <xsl:template match="db:section|db:sect1|db:sect2|db:sect3|db:sect4|db:sect5        |db:simplesect|db:bridgehead" mode="m:object-title-template">
        <xsl:choose>
    ...
    <xsl:template match="db:procedure" mode="m:object-title-template">
        <xsl:choose>
            <xsl:when test="$formal.procedures != 0 and title">
                <xsl:call-template name="gentext-template">
                    <xsl:with-param name="context" select="'title'"/>
                    <xsl:with-param name="name" select="concat(f:xpath-location(.), '.formal')"/>
                </xsl:call-template>
            </xsl:when>
            <xsl:otherwise>
                <xsl:call-template name="gentext-template">
...
<!-- ============================================================ -->
    <doc:mode xmlns="http://docbook.org/ns/docbook" name="m:object-subtitle-template">
...
that should be used to generate its subtitle.</para>
    ...
    <xsl:template match="db:itemizedlist                      |db:orderedlist" mode="m:object-subtitle-template">
...
<!-- ============================================================ -->
    <doc:mode xmlns="http://docbook.org/ns/docbook" name="m:object-xref-template">
...
<!-- ============================================================ -->
    <doc:mode xmlns="http://docbook.org/ns/docbook" name="m:autonumbered">
...
“0” otherwise.</para>
    ...
    <xsl:template match="db:section|db:sect1|db:sect2|db:sect3|db:sect4|db:sect5" mode="m:autonumbered">
        <xsl:choose>
    ...
    <xsl:template match="db:question|db:answer" mode="m:autonumbered">
        <xsl:choose>
            <xsl:when test="$qanda.defaultlabel = 'number'                     and not(db:label)">
                <xsl:value-of select="'1'"/>
            </xsl:when>
            <xsl:otherwise>
...
<!-- ============================================================ -->
    <doc:mode xmlns="http://docbook.org/ns/docbook" name="m:object-title-markup">
...
<!-- ============================================================ -->
    <doc:mode xmlns="http://docbook.org/ns/docbook" name="m:object-titleabbrev-markup">
...
<!-- ============================================================ -->
    <doc:mode xmlns="http://docbook.org/ns/docbook" name="m:object-subtitle-markup">
...
<!-- ============================================================ -->
    <doc:mode xmlns="http://docbook.org/ns/docbook" name="m:object-xref-markup">
...
<!-- ============================================================ -->
    <doc:template xmlns="http://docbook.org/ns/docbook" name="substitute-markup">
...
<!-- I have to be able to distinguish between the case where no title has been
    ...
    <xsl:variable name="ghost:marker" as="element(ghost:marker)">
        <ghost:marker/>
    </xsl:variable>
...
<!-- ============================================================ -->
    <doc:template xmlns="http://docbook.org/ns/docbook" name="make-gentext-template">
...
defaults to the language of the context node.</para>
  ...
  <!-- parse xrefstyle to get parts -->
        ...
        <xsl:variable name="pagetype">
            <xsl:choose>
                <xsl:when test="$olink.insert.page.number = 0                       and local-name($referrer) = 'olink'">
        ...
        <xsl:variable name="docnametype">
            <xsl:choose>
                <xsl:when test="$olink.doctitle = 0                       and local-name($referrer) = 'olink'">
        <!-- suppress docname -->
                </xsl:when>
